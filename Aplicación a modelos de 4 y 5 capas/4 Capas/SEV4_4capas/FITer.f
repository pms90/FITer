     ...
     #x,lll,iii,jjj
      ...
      !-----------------------------------------------------------------
      !-----------------------------------------------------------------
      ! Parametros para modificar el procesamiento:

      nc=4 !Numero de capas del modelo semilla (max=10)

      ra=0.9  !rango inicial de busqueda (como porsentaje de cantidad ajustada p o e)(0.5 busca en +- 50% del valor semilla en la primer iteracion)
      ...
      ite=40  !en cada iteracion "ite" se ajustan una vez cada variable p y e, acortando el rango de busqueda segun los parametros "ra" y "fra".
      omax=6  !iteraciones globales (cada iteracion repite todas las iteraciones "ite" volviendo a usar el parametro "ra" inicial)
      ...
      rms_anterior=1000.   !Para controlar errores (se pide rms < rms_anterior en cada iteracion)
